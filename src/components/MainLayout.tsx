    ...
    <main className="min-h-screen max-w-screen overflow-x-hidden">
      ...
      >
        ...
        <defs>
          ...
          >
            <stop stopColor="#00404C"></stop>
            <stop offset="1" stopColor="#08D0B0"></stop>
          </linearGradient>
        </defs>
      </svg>
      <div className="border-l-[3px] border-white h-[314px] absolute left-4 z-10"></div>
      <div className="border-l-[2px] border-white h-[407px] absolute left-[26px] z-10"></div>
      <div className="flex justify-between pl-10 pt-10  z-10 w-full ">
        <div className="flex flex-col min-h-screen justify-between w-full">
          <div className="text-white space-y-8 z-10">
            <div className="space-y-2">
              ...
              <p className="text-[14px]">Süni intelekt sistemi</p>
            </div>
            <p className="max-w-[214px] text-[14px] leading-[20px]">
              Bu formu doldurduqdan sonra öz yaşıdlarınız arasında ən yaxşı
              hansı faizlikdə olduğunuzu müəyyən edə biləcəksiniz.
            </p>
          </div>
        </div>
        <div className="flex flex-1 justify-end pr-32 mt-10 min-w-[1130px] max-w-[1175px]">
          <div className="flex flex-col items-end space-y-5 top-1">
            {stages.map((stage, i) => (
              <div
                key={i}
                className={`flex items-center justify-between w-full gap-4 px-3 pl-4 py-2 rounded-l-full text-[16px]  ${
                  i === 0
                    ? "bg-SecondaryColor text-white min-w-[200px]"
                    : "bg-LightColor text-black max-w-[170px]"
                }`}
              >
                {i === 0 && <span>{i + 1}.</span>}
                <span className={`${i === 0 && "w-full text-end "}`}>
                  {stage}
                </span>
              </div>
            ))}
      ...
      <div className="absolute left-[220px] top-[460px] w-80 h-80">
        <img src={eduFrame} alt="frame" className="w-full h-full" />
      </div>
    </main>
  );
};
